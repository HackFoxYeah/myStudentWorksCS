...
namespace практическаяРабота_5
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            textBoxResults.Text += $"  >>>  Сумма пар чисел - ({_firstPair.FirstValue + _secondPair.FirstValue + _thirdPair.FirstValue}," +
                                   $" {_firstPair.SecondValue + _secondPair.SecondValue + _thirdPair.SecondValue}). \n\n";
        }
        ...
        {
            MessageBox.Show("Практическая работа №5. \nТекст задания: Создать класс Pair (пара чисел). Создать необходимые методы и свойства. \r\nОпределить методы метод сложения полей и операцию сложения пар (а, b) + (с, d) = (а + c, b + d). Создать перегруженные методы для увеличения полей на 1, сложения трех пар чисел.");
        }
